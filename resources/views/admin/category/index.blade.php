   ...
   <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <a href="{{$route."/create"}}" class="btn btn-success m-b-30"><i class="fas fa-plus"></i> Add Category</a>
                        ...
                        @foreach($category as $key=>$val)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form
                                        onsubmit="if(confirm('Do You Really Want To Delete The Category?') == false) return false;"
