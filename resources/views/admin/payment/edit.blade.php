            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form method="post" action="{{ $route."/".$payment->id }}" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group">
                                ...
                                <select name="player_id" id="player_id" class="form-control select">
                                    @foreach($player as $key)
                                        <option value="{{$key->id}}" @if($payment->player_id == $key->id) selected @endif>{{$key->full_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="full_name"
                                       placeholder="Price" name="price" value="{{$payment->price}}">
                            </div>
