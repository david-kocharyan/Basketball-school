   ...
   <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <a href="{{$route."/create"}}" class="btn btn-success m-b-30"><i class="fas fa-plus"></i> Add Venues</a>
                        ...
                        @foreach($center as $key=>$val)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form
                                        onsubmit="if(confirm('Do You Really Want To Delete The Center?') == false) return false;"
