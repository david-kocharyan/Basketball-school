...
@section("content")
    ...
    <div class="story-section pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="title pb-3"><img style="height: 30px" class="img-fluid" src="{{ asset("assets/site/images/ball-red.svg") }}" alt="Ball">Our Story</p>
                    <p class="subtitle"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad consectetur inventore maxime, quaerat rerum voluptatem. Asperiores aspernatur fugiat harum nam natus soluta veritatis? Asperiores eum ex exercitationem neque pariatur repellendus? </p>
                </div>
                <div class="col-md-6">
                    <p class="title pb-3"><img style="height: 30px" class="img-fluid" src="{{ asset("assets/site/images/ball-red.svg") }}" alt="Ball">Why Cilicia</p>
                    <p class="subtitle"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad consectetur inventore maxime, quaerat rerum voluptatem. Asperiores aspernatur fugiat harum nam natus soluta veritatis? Asperiores eum ex exercitationem neque pariatur repellendus? </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12 col-xl-6 overlay-part">
                        ...
                        <div class="col-xl-8 col-sm-12 d-flex justify-content-center pt-3 list-section">
                            ...
                            <div class="value-part ml-4">
                                <p class="value-title">Core Values</p>
                                <p class="value-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam at deleniti dolore, dolorem doloremque error exercitationem fugit.</p>
                            </div>
                        </div>
                        <div class="col-xl-8 col-sm-12 d-flex justify-content-center pt-3 list-section">
                            <div class="icon-cont d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-xl-8 d-flex col-sm-12 justify-content-center pt-3 list-section">
                            <div class="icon-cont d-flex align-items-center justify-content-center">
                                <img class="img-fluid" src="{{ asset("assets/site/images/about/script.svg") }}" alt="">
                            </div>
                            <div class="value-part ml-4">
        ...
        <div class="container pt-5 our-team">
            <p class="title pb-3"><img style="height: 30px" class="img-fluid" src="{{ asset("assets/site/images/ball-red.svg") }}" alt="Ball">Our Team</p>
            <div class="row">
                <div class="col-md-6">
                    <div class="main-box" style="background-image: url('{{ asset("assets/site/images/about/coach.jpg") }}')">
                        <div class="red-overlay d-flex align-items-center">
                            <div class="col-md-12">
                                <span class="badge badge-light">Founder</span>
                                <h6 class="member-name text-white text-uppercase mt-2 mb-3">Name Surname</h6>
                                <p class="member-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid atque beatae.</p>
                            </div>
                        </div>
                    </div>
                </div>
