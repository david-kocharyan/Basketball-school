        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 d-flex align-items-lg-center shop-text-cont p-3">
                    <p class="text-white m-0 shop-text text-center col-12">OUR NEW ONLINE SHOP IS NOW OPEN! CHECK IT
                        OUT!</p>
                </div>
                                ...
                                <div class="swiper-slide finished-games d-flex flex-column justify-content-center">
                                    <div class="first-row d-flex justify-content-around align-items-center">
                                        ...
                                        <div class="time-cont mt-md-5 d-flex justify-content-around">
                                            <div class="date-cont d-inline-block game-score left text-md-right"
                                                 style="width: 100px;">
                                                <span class="team"
                                    ...
                                    <div class="second-row d-flex flex-column align-items-center">
                                        ...
                                        <span
                                            class="finals mb-3 text-white text-center text-uppercase">Top Performance: {{$val->best_player}}</span>
                                    </div>
                ...
                @foreach($best_players as $key)
                    <div class="col-md-3">
                        <div class="main-box"
                            ...
                            <img src="{{ asset("uploads/player/")."/".$key->players->image }}" alt="">
...
{{--                                        </a>--}}
    ...
    @push('head')
        ...
        <style>
            ...
            .gallery-top-buttons .prev-top:focus, .gallery-top-buttons .next-top:focus {
                outline: none;
            }
